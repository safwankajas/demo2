...
function Clouder(params) {
    ...
    function onMouseMove(e) {
      ...
      setClosest(
        findClosest(e.clientX - containerLeft, e.clientY - containerTop)
      );
    } // onMouseMove
      ...
      process(function (o) {
        if (!o.span) {
          ...
          for (var i in colorMax) {
            c =
              c * 256 +
              Math.floor((colorMax[i] - colorMin[i]) * o.weight + colorMin[i]);
          } // for
  ...
  // calling it
  // const cloudColor = getComputedStyle(document.documentElement).getPropertyValue(
  //   "--third-clr-1"
  // );
  // const cloudColor0 = getComputedStyle(document.documentElement).getPropertyValue(
  //   "--third-clr-4"
  // );
  new Clouder({
    container: document.getElementById("cloud"),
    tags: [
      { text: "React", id: "1", weight: 1 },
      { text: "css", id: "2", weight: 1 },
      { text: "tailwind", id: "3", weight: 1 },
      { text: "html", id: "4", weight: 1 },
      { text: "typeScript", id: "5", weight: 1 },
      { text: "ReactNative", id: "6", weight: 1 },
      { text: "JS", id: "7", weight: 1 },
      { text: "Git", id: "8", weight: 1 },
      { text: "BEM", id: "9", weight: 1 },
      { text: "spline", id: "10", weight: 1 },
      { text: "blender", id: "11", weight: 1 }
    ],
